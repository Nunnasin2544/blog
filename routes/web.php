...
Route::get('/show_post', [AdminController::class, 'show_post'])->middleware('admin');
Route::get('/delete_post/{id}', [AdminController::class, 'delete_post'])->middleware('admin');
Route::get('/edit_page/{id}', [AdminController::class, 'edit_page'])->middleware('admin');
Route::post('/update_post/{id}', [AdminController::class, 'update_post'])->middleware('admin');
Route::get('/accept_post/{id}', [AdminController::class, 'accept_post'])->middleware('admin');
Route::get('/reject_post/{id}', [AdminController::class, 'reject_post'])->middleware('admin');
